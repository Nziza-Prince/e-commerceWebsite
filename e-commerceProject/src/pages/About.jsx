...
const About = () => {
  ...
  return (
    <div>
      {/* ABOUT US Heading */}
      <h1 className="mt-16 mb-12 text-2xl text-center" data-aos="fade-up">
        ABOUT US
      </h1>
      ...
      <div className="mx-8 lg:mx-48 flex flex-wrap lg:flex-nowrap gap-5 mb-20">
        ...
        <div className="w-full lg:w-2/5 flex mt-10 lg:mt-20 flex-col gap-6 px-4">
          ...
          <h1 className="font-semibold text-gray-900" data-aos="fade-up" data-aos-delay="400">
            Our Mission
          </h1>
          <p className="text-gray-500" data-aos="fade-up" data-aos-delay="600">
      ...
      <h1 className="mt-48 mb-5 text-left ml-8 lg:ml-64 text-2xl" data-aos="fade-up">
      ...
      <div className="flex flex-wrap lg:flex-nowrap  mx-8 lg:mx-64 mb-48">
        {/* Box 1 */}
        <div className="border p-10 md:p-14 lg:p-20 flex flex-col gap-1 text-gray-500 w-full lg:w-1/3" data-aos="fade-up" data-aos-delay="300">
        ...
        {/* Box 2 */}
        <div className="border p-10 md:p-14 lg:p-20 flex flex-col gap-1 text-gray-500 w-full lg:w-1/3" data-aos="fade-up" data-aos-delay="500">
          <h1 className="font-semibold mb-4 text-gray-900 text-center lg:text-left">
            CONVENIENCE
          </h1>
        ...
        {/* Box 3 */}
        <div className="border p-10 md:p-14 lg:p-20 flex flex-col gap-1 text-gray-500 w-full lg:w-1/3" data-aos="fade-up" data-aos-delay="700">
          <h1 className="font-semibold mb-4 text-gray-900 text-center lg:text-left">
